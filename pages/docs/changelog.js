    ...
    <ul className='list-unstyled'>
      ...
      <li className='d-flex align-items-start mb-3'>
        ...
        <div>
          ...
          component that properly supports custom animated svg <code>placeholder</code>.
          We&apos;ll switch to the new <code>Image</code> component as soon as Nex.js fixed the issue.
          Read the <a href='https://github.com/vercel/next.js/issues/42140' target='_blank' rel='noreferrer'>issue thread here</a>.
        </div>
      </li>
      <li className='d-flex align-items-start mb-3'>
        <span className='badge bg-warning fs-sm pt-1 me-3'>Fixed</span>
        <div>
          Page <code>title</code> that breaks the page after updating to Next.js 13. The error message:
